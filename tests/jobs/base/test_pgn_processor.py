...
[EventDate "EventDate"]
    ...
    def test_process_game_ply_should_identify_promoted_unit(self):
        pgn_stream = StringIO('1. e4 d5 2. e5 d4 3. e6 d3 4. exf7+  Kd7 5. fxg8=Q dxc2 6. Qf3 cxb1=N')
        pgn_processor = PGNProcessor(pgn_stream)
    ...
    def test_process_game_ply_should_identify_stalemate(self):
        ...
        pgn_stream = StringIO("1. e3 a5 2. Qh5 Ra6 3. Qxa5 h5 4. h4 Rah6 5. Qxc7 f6 6. Qxd7+ Kf7 7. Qxb7 Qd3 8.Qxb8 Qh7 9. Qxc8 Kg6 10. Qe6 1/2-1/2")
        pgn_processor = PGNProcessor(pgn_stream)
    ...
    def test_process_game_ply_should_identify_insufficient_material(self):
        ...
        pgn_stream = StringIO('''1. e4 d5 2. exd5 Qxd5 3. Bb5+ Qxb5 4. Nc3 Qxb2 5. Bxb2 Bg4 6. Qxg4 Nf6 7. Qxg7
