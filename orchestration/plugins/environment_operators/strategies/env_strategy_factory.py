...
from environment_operators.strategies.sibling_docker_env_strategy import (
    SiblingDockerEnvStrategy,
)


class EnvironmentStrategyFactory:
    STRATEGIES = {EnvironmentStrategyEnum.SIBLING_DOCKER: SiblingDockerEnvStrategy}

    def create(
        self, strategy: EnvironmentStrategyEnum, **kwargs
    ) -> EnvironmentStrategy:
